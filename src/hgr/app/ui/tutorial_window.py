...
class TutorialWindow(QDialog):
    ...
    def _apply_step_content(self) -> None:
        ...
        instruction_map = {
            ...
            "mouse_mode": (
                "How to do it:\n"
                "\u2022 Turn mouse mode on: face your LEFT palm to the monitor, extend only index, middle, and ring fingers (thumb and pinky folded), and hold briefly.\n"
                "\u2022 Move the cursor: with your RIGHT hand open-palm facing the monitor, move your hand inside the camera frame.\n"
                "\u2022 Left-click: bend your right index finger down and straighten it back up.\n"
                "\u2022 Right-click: bend your right middle finger down and straighten it back up.\n"
                "\u2022 Scroll: keep your right index and middle fingers extended together (ring and pinky folded) and move your hand up to scroll up or down to scroll down.\n"
