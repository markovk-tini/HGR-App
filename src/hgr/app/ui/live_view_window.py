...
class LiveViewWindow(QMainWindow):
    ...
    def __init__(self, config: AppConfig, worker: Optional[object] = None):
        ...
        self.setWindowTitle("HGR Live View")
    ...
    def _build_ui(self) -> None:
        ...
        self.title_label = QLabel("HGR Gesture Live View")
        ...
        note = QLabel(
            "This app live view mirrors the active HGR runtime. Use it to watch the live hand skeleton, finger-state reasoning, gesture status, system-volume feedback, app control state, and voice state while the app is running."
        )
