...
<body>
  ...
  <div class="hint">The first time, your browser will ask for camera permission — tap Allow.
    On iOS Safari, if you see a certificate warning, tap "Show Details" then "visit this website".</div>
...
(() => {
  ...
  async function startLoop() {
    ...
    try {
      ...
      setStatus("Could not connect back to PC. Keep Touchless open on your PC and retry.", "err");
      startBtn.disabled = false;
      startBtn.textContent = "Start";
      return;
    }
