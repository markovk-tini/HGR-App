...
from .live_dictation_streamer import LiveDictationStreamer
...
class DebugWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.title_label = QLabel("HGR Gesture Debugger")
    ...
    def start_session(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "HGR Debug", str(exc))
            return
        ...
        if cap is None or camera_info is None:
            ...
            QMessageBox.warning(self, "HGR Debug", "No available camera was found.")
            return
